  ...
  return (
    <div className="trace-timeline">
      <div className="trace-timeline__header">
        ...
        {events.length > 0 && (
          <span className="trace-timeline__badge">{events.length} events</span>
        )}
      </div>

      {events.length === 0 && !loading && (
        <div className="trace-timeline__empty">
          No trace events yet. Submit an intent to begin.
        </div>
      )}
            ...
            return (
              ...
              >
                ...
                <div className="trace-event__content">
                  ...
                  {ev.message && (
                    <p className="trace-event__message">{ev.message}</p>
                  )}
                  ...
                  <div className="trace-event__meta">
                    {ev.actor && (
                      <span className="trace-event__meta-item">
                        ...
                        <span className="mono trace-event__meta-val">
                          {truncateAddr(ev.actor)}
                        </span>
                      </span>
                    )}
                    {ev.txHash && (
                      <span className="trace-event__meta-item">
                        <span className="trace-event__meta-label">tx</span>
                          ...
                          className="trace-event__tx-link"
