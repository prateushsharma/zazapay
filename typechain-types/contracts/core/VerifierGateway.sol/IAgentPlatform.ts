...
export interface IAgentPlatformInterface extends Interface {
  getFunction(
...
export interface IAgentPlatform extends BaseContract {
  connect(runner?: ContractRunner | null): IAgentPlatform;
  waitForDeployment(): Promise<this>;

  interface: IAgentPlatformInterface;
